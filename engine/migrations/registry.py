...
_MIGRATIONS = (
    ...
    Migration.create(
        13, v013_external_agents.NAME, v013_external_agents.SQL,
        verify=v013_external_agents.verify),
    Migration.create(
    ...
    Migration.create(19, v019_urban_development.NAME, v019_urban_development.SQL, verify=v019_urban_development.verify),
)
