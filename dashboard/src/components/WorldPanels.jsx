...
export function FirmsPanel({ firms }) {
  ...
  return (
    <Panel title="Firms & exchange" eyebrow="Production · payroll · price discovery" className="col-span-full lg:col-span-5">
      <div role="group" className="flex min-h-10 items-center gap-2 overflow-x-auto border-b border-mint-300/10 bg-ink-950/35 px-4 py-2" aria-label="Live stock ticker">
      ...
      <div role="region" aria-label="Firms and exchange records" tabIndex={0} className="scrollbar max-h-[430px] overflow-auto">
