...
function displayParams(state) {
  const { agent, firm, place, project, household, institution, view, layer, population, q, activeOnly, camera, follow } = state;
  return patchObserverViewState(new URLSearchParams(), {
    agent, firm, place, project, household, institution, view, layer, population, q, activeOnly, camera, follow,
  });
}
