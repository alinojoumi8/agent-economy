...
| [AgentSociety 2](https://agentsociety2.readthedocs.io/) | LLM-native simulation/research platform | Stateless workspace-bound agents, multiple reasoning patterns, Ray task execution, research workflows | README advertises JSONL catalog replay with DuckDB reads and distributed tracing | Modern experiment harness, scalable inference, replay-oriented tooling | Its “replay” is experiment/trace oriented; it is not evidence of Agent Economy-style semantics-versioned, table-hash-identical institutional replay |
