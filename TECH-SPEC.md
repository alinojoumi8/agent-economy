...
for billing/spending-limit reasons; it is not a failed code test and does not
waive any required CI job. No public
...
operations. Release-gate PR #20 remains draft.
