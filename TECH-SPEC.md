...
- The fresh V9 precommit tree passed 659 Python tests with 8 environment-gated skips, 23 dashboard tests, a fresh 603-module build, pinned-dataset verification, dependency checks, and `git diff --check`.
