...
RELEASE_CAMPAIGN_ID = "oracle-calibration-v6"
RELEASE_CAMPAIGN_VERSION = 6
RELEASE_SEEDS = tuple(range(7351, 7361))
RELEASE_PROFILES = {
    seed: f"v6-seed-{seed}-{'rumor' if seed % 2 == 0 else 'control'}.yaml"
